...
Symbals.MissionButton = function(gameState, position, texture, callback, context, group, properties) {
  "use strict";
...
Symbals.MissionButton.prototype = Object.create(Phaser.Button.prototype);
Symbals.MissionButton.prototype.constructor = Symbals.MissionButton;

Symbals.MissionButton.prototype.update = function () {
  "use strict";
}

Symbals.MissionButton.prototype.big = function() {
...
Symbals.MissionButton.prototype.circle = function() {
...
Symbals.MissionButton.prototype.clicked = function() {
