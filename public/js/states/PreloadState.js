...
Symbals.PreloadState = function () {
  "use strict";
  Symbals.BaseState.call(this);
};

Symbals.PreloadState.prototype = Object.create(Symbals.BaseState.prototype);
Symbals.PreloadState.prototype.constructor = Symbals.PreloadState;

Symbals.PreloadState.prototype.preload = function () {
  "use strict";
  ...
  game.load.bitmapFont('SymbalsNum', 'assets/num.png', 'assets/num.xml');
...
Symbals.PreloadState.prototype.create = function () {
  "use strict";
  game.soundManager = new Symbals.SoundManager();
