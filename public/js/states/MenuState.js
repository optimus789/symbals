...
Symbals.MenuState = function () {
  "use strict";
  Symbals.BaseState.call(this);
};

Symbals.MenuState.prototype = Object.create(Symbals.BaseState.prototype);
Symbals.MenuState.prototype.constructor = Symbals.MenuState;

Symbals.MenuState.prototype.create = function () {
  "use strict";
...
Symbals.MenuState.prototype.onNextState = function() {
